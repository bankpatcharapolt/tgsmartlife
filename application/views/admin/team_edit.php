        ...
        <form method="post" action="<?//=base_url('admin/Product/product_actions');?>" enctype="multipart/form-data" id="action-form">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group row">
                        <div class="col-md-12 ">
                            <label class="control-label">ชื่อ ทีม</label>
...
<script>
    ...
    function get_results(base_url){
        var res = null;
        $.ajax({
            url: base_url+'/admin/Teams/get_results_once', //ทำงานกับไฟล์นี้
            data: {
    ...
    $("form#action-form").on("submit",function(e){ // จะทำงานก็ต่อเมื่อกด submit ฟอร์ม
        ...
        $.ajax({
            url:base_url+'admin/Teams/actions', //ให้ระบุชื่อไฟล์ PHP ที่เราจะส่งค่าไป
            type:'post',
            dataType: 'json',
