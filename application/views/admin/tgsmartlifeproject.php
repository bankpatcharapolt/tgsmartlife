...
<div class="col-md-12 col-sm-12  ">
    <div class="x_panel">
        <div class="x_title">
            <h2>TG Smart life Project<small></small></h2>
...
<script>
    ...
    function get_results(base_url){
        var res = null;
        $.ajax({
            url: base_url+'/admin/Others/get_tgsmartlifeproject', //ทำงานกับไฟล์นี้
            data: {
    ...
    $("form#edit-form").on("submit",function(e){ // จะทำงานก็ต่อเมื่อกด submit ฟอร์ม
        ...
        $.ajax({
            url:base_url+'admin/Others/actions_tgsmartlifeproject', //ให้ระบุชื่อไฟล์ PHP ที่เราจะส่งค่าไป
            type:'post',
            dataType: 'json',
