        ...
        <form method="post" action="<?//=base_url('admin/Product/product_actions');?>" enctype="multipart/form-data" id="edit-form">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6 ">
                            <label class="control-label">จำนวนที่เปิดรับ</label>
...
<script>
    ...
    function drawform(base_url){
        ...
        if(results){
            ...
            $('form#edit-form #counts').val(results.datas[0].counts);
            $('form#edit-form #details').val(results.datas[0].detail).change();
    ...
    function get_results(base_url){
        var res = null;
        $.ajax({
            url: base_url+'/admin/Career/get_results_once', //ทำงานกับไฟล์นี้
            data: {
    ...
    $("form#edit-form").on("submit",function(e){ // จะทำงานก็ต่อเมื่อกด submit ฟอร์ม
        ...
        $.ajax({
            url:base_url+'admin/Career/career_actions', //ให้ระบุชื่อไฟล์ PHP ที่เราจะส่งค่าไป
            type:'post',
            dataType: 'json',
