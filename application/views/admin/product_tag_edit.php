                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-4  ">
                            ...
                            <div class="input-group demo2 colorpicker-element">
                                <input type="text" value="" class="form-control" name="backgroundcolor" id="backgroundcolor" >
                    ...
                    <div class="form-group" style="border-top: 1px solid #dee2e6;">
                        <div class="col-12" style="padding: 13px 0;">
                            <a id="back-btn" href="<?=base_url("admin_product_tag");?>" class="btn btn-warning text-center" style="" type="button">กลับ</a>
...
<script>
    ...
    function drawform(base_url){
        ...
        if(results.datas.length > 0){
            ...
            $('form#action-form #backgroundcolor').val(results.datas[0].backgroundcolor);
    ...
    function get_results(base_url){
        var res = null;
        $.ajax({
            url: base_url+'/admin/Product/get_product_tag_onc', //ทำงานกับไฟล์นี้
            data: {
    ...
    $("form#action-form").on("submit",function(e){ // จะทำงานก็ต่อเมื่อกด submit ฟอร์ม
        ...
        $.ajax({
            url:base_url+'admin/Product/tag_actions', //ให้ระบุชื่อไฟล์ PHP ที่เราจะส่งค่าไป
            type:'post',
            dataType: 'json',
