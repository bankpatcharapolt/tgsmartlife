        ...
        if(results.datas.length > 0){   
            ...
            $.each( results.datas, function( key, val ) {
               ...
               tr += '<td style="vertical-align: inherit;">'+val.name+'</td>';
                ...
                tr += '<li><a href="'+base_url+'admin_team_edit/'+val.id+'" class="btn btn-round btn-warning" style="font-size: 11px; padding: 4px 8px;" data-toggle="tooltip" title="แก้ไข"><i class="fa fa-wrench"></i></a></li>';
                tr += '<li><button class="btn btn-round btn-warning user-btn" style="font-size: 11px; padding: 4px 8px;" data-toggle="tooltip" title="User, Pass" onclick="draw_user_pass('+val.id+')" ><i class="fa fa-user"></i></button></li>';
