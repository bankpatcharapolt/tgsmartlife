            ...
            <div class="col-lg-12">
                <div class="breadcrumb__text">
                    ...
                    <div class="breadcrumb__links">
                        ...
                        <a href="<?=base_url('knowledge');?>">องค์ความรู้</a>
...
<script>
    ...
    function drawcontens(base_url){
        ...
        //###  images ###//
        var knowledge_images = get_knowledge_images(base_url);
        var img = '';
        if(knowledge_images.datas.length > 0){
            img += '<div class="row">';
            $.each( knowledge_images.datas, function( key, val ) {
    ...
    function get_results(base_url){
        var res = null;
        $.ajax({
            url: base_url+'Main/get_knowledge_once', //ทำงานกับไฟล์นี้
    ...
    function get_knowledge_images(base_url){
        var res = null;
        $.ajax({
            url: base_url+'Main/get_knowledge_images', //ทำงานกับไฟล์นี้
            data: {'id':"<?=$id;?>"},  //ส่งตัวแปร
            type: "POST",
            dataType: 'json',
            async:false,
